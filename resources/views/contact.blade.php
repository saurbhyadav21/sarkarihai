...
@section('content')
    <div class="container py-5" style="    color: #fff;">
        ...
        <p>
            <strong>संजय सिंह</strong> पिछले कई वर्षों से शिक्षा और प्रतियोगी परीक्षाओं से संबंधित
            विषयों पर लेखन कर रहे हैं। उन्हें कंटेंट राइटिंग के क्षेत्र में लगभग
            <strong>6 वर्षों का अनुभव</strong> है और वे सरकारी नौकरी, परीक्षा नोटिफिकेशन,
            एडमिट कार्ड और रिजल्ट से संबंधित जानकारी सरल भाषा में प्रदान करते हैं।
        </p>

        <p>
            उन्होंने <strong>English Literature में Master’s Degree</strong> प्राप्त की है और
