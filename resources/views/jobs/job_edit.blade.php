        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="last_fee_date" value="{{ $job->last_fee_date }}" class="form-control">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="correction_date" value="{{ $job->correction_date }}" class="form-control">
                </div>
                <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="admit_card" value="{{ $job->admit_card }}" class="form-control">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="result_date" value="{{ $job->result_date }}" class="form-control">
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" name="genral_fees" value="{{ $job->genral_fees }}" class="form-control">
                </div>
                <div class="col-md-3 mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" name="max_age_genral" value="{{ $job->max_age_genral }}" class="form-control">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label">Max Age OBC</label>
                    <input type="text" name="max_age_obc" value="{{ $job->max_age_obc }}" class="form-control">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label">Max Age SC/ST</label>
                    <input type="text" name="max_age_sc_st" value="{{ $job->max_age_sc_st }}" class="form-control">
                </div>
            </div>
