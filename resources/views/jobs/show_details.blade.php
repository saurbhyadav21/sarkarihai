...
@section('content')
            ...
            @php
                ...
                $relatedJobs = DB::table('job_details')
                    ...
                    ->where(function ($q) use ($job) {
                        $q->where('category', $job->category)->orWhere('state', $job->state);
                    })
                        ...
                        @foreach ($relatedJobs as $item)
                            @php
                                ...
                                if (!empty($item->end_date)) {
                                    ...
                                    $lastDate = strtotime(date('Y-m-d', strtotime($item->end_date)));
                            ...
                            <a class="related-item"
                                ...
                                <div class="related-vacancy">
                                    👥
                                    @if (is_numeric($item->total_vacancies))
                                        {{ number_format((int) $item->total_vacancies) }}
                                    @else
                                        N/A
                                    @endif
                                </div>
    ...
    <div class="author-box d-flex align-items-center">
        ...
        <div class="me-3">
            ...
            <img src="{{ asset('images/authors/saurabh-yadav.webp') }}"
                 alt="Saurabh Yadav"
                 width="80"
                 height="80"
        ...
        <div class="author-content">
            ...
            <div class="text-muted mb-2">
                ...
                Founder & Editor • SarkariHai

            </div>

            <p class="mb-2">

                Saurabh Yadav has over 10 years of experience in web development and government job content publishing. Every recruitment article is reviewed using official notifications before publication.
